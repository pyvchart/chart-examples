...
c = (
    ...
    .set_sequence_spec(
        ...
        series=[
            _gen_bar(
                data_id="register", x_field_name="start_time", y_field_name="end_time"
            ),
            _gen_bar(data_id="im", x_field_name="start_time", y_field_name="end_time"),
            _gen_bar(
                data_id="comment", x_field_name="start_time", y_field_name="value"
            ),
            _gen_dot(),
            _gen_link(),
        ],
...
c.render("sequence_example.html")
