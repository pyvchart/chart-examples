...
c = (
    ...
    .set_data(data=[opts.BaseDataOpts(id_="data", values=TEST_WORDCLOUD3D_DATA)])
    .set_wordcloud3d_spec(
        name_field="challenge_name",
        value_field="sum_count",
        mask_shape="https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/log.jpeg",
...
c.render("wordcloud3d_example.html")
