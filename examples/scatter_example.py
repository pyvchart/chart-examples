...
from pyvchart.charts import Common, Scatter
...
def _gen_scatter_series() -> dict:
    c = (
        Scatter()
        .set_xy_field(
            x_field_name="milesPerGallon",
            y_field_name="horsepower",
        )
        .set_scatter_spec(
            point_opts=opts.PointOpts(
...
c = (
    Common()
    .set_data(data=[opts.BaseDataOpts(values=TEST_SCATTER_DATA)])
    .set_common_spec(series=[_gen_scatter_series()])
    .set_global_options(
        tooltip_opts=opts.TooltipOpts(
            dimension_opts=opts.TooltipCustomOpts(is_visible=True),
        ...
        crosshair_opts=opts.CrossHairOpts(
            y_field=opts.CrossHairFieldOpts(
                is_visible=True,
                is_line_visible=True,
                line_type="line",
                is_label_visible=True,
            ),
            x_field=opts.CrossHairFieldOpts(
                is_visible=True,
                is_line_visible=True,
                line_type="line",
                is_label_visible=True,
        ...
        axes_opts=[
            opts.AxesLinearOpts(
                base_axes_opts=opts.BaseAxesOpts(
                    orient="left",
                    title=opts.BaseTitleTextStyleOpts(
                        text="Horse Power",
                        base_style_opts=opts.BaseStyleOpts(is_visible=True),
                    ),
                ),
            ),
            opts.AxesLinearOpts(
