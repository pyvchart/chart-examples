...
c = (
    ...
    .set_sankey_spec(
        ...
        node_width=10,
        min_node_height=4,
        node_opts=opts.SankeyNodeOpts(
            state=opts.BaseStateOpts(
                hover_opts=opts.BaseStyleOpts(stroke="#333333"),
        ...
        link_opts=opts.SankeyLinkOpts(
            state=opts.BaseStateOpts(
                hover_opts=opts.BaseStyleOpts(fill_opacity=1),
                selected_opts=opts.BaseStyleOpts(
                    fill="#dddddd",
                    stroke="#333333",
                    line_width=1,
        ...
        label_opts=opts.LabelOpts(
            is_visible=True,
            style_opts=opts.BaseStyleOpts(font_size=10),
        ),
    )
    .set_global_options(
        title_opts=opts.TitleOpts(
            text="How energy is converted or transmitted before being consumed or lost",
            sub_text="Data: Department of Energy & Climate Change via Tom Counsell",
            sub_text_style_opts=opts.BaseTitleTextStyleOpts(font_size=12),
        ),
    )
)
c.render("sankey_example.html")
